...
class AutoBot
{
    ...
    public function __construct($baseUrl = null)
    {
        ...
        Browser::$storeScreenshotsAt = storage_path(config('autobot.storage.screenshots'));

        Browser::$storeConsoleLogAt = storage_path(config('autobot.storage.logs'));
    }
    ...
    protected function driver()
    {
        ...
        $options = (new ChromeOptions)->addArguments(config('autobot.driver.options'));

        return RemoteWebDriver::create(
            config('autobot.driver.url'), DesiredCapabilities::chrome()->setCapability(
